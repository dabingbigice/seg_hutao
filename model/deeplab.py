...
from model.nets.deeplabv3_plus import DeepLab
from model.utils.utils import cvtColor, preprocess_input, resize_image, show_config
...
class DeeplabV3(object):
    ...
    def __init__(self, **kwargs):
        ...
        if self.num_classes <= 21:
            self.colors = [(255, 255, 255), (0, 0, 0), (201, 1, 3), (128, 128, 0), (0, 0, 128), (128, 0, 128),
                           (0, 128, 128),
    ...
    #   检测图片
    # ---------------------------------------------------#
    def detect_image(self, image, count, name_classes=None):
        # ---------------------------------------------------------#
